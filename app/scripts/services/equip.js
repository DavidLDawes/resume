        ...
        return {
            ...
            generateSoldier: function (gener, equipm) {
                ...
                soldier = {
                    ...
                    'ac': 10,
                    'thac0': [20, 20, 20, 20, 20, 20, 20, 20, 20, 20],
                    'mine': 'true'
                };

                // assign a weapon
                totWeap = 0;
                for (i = 0; i < equipm.weapontypeodds.length; i = i + 1) {
                    totWeap += equipm.weapontypeodds[i];
                }
                i = Math.floor(Math.random() * (totWeap));
                totWeap = 0;
                k = 0;
                for (j = 0; j < equipm.weapontypeodds.length; j = j + 1) {
                ...
                // assign armor
                totArmor = 0;
                for (i = 0; i < equipm.armortypeodds.length; i = i + 1) {
                    totArmor += equipm.armortypeodds[i];
                }
                i = Math.floor(Math.random() * (totArmor));
                totArmor = 0;
                k = 0;
                for (j = 0; j < equipm.armortypeodds.length; j = j + 1) {
                ...
                // str
                k = 0;
                for (i = 0; i < gener.str.dice; i = i + 1) {
                ...
                // dex
                k = 0;
                for (i = 0; i < gener.dex.dice; i = i + 1) {
                ...
                // con
                k = 0;
                for (i = 0; i < gener.con.dice; i = i + 1) {
